    ...
    <header className={classes.header}>
        <div className={classes.headerInnerDiv}>
           <Link to="/" className={classes.link}>
            <h1 className={classes.siteTitle}> {siteTitle}
            ...
            <nav>
              <div className={classes.isMobileLayout}>
                ...
                <Menu
                  ...
                  onClose={handleClose}
                >
                  {menuLinks.map(link => (<MenuItem onClick={handleClose} key={link.name} className={classes.listItem}>{link.name}</MenuItem>))}
                </Menu>
              </div>
                ...
                <ul className={classes.linkInnerWrapper}>
                  {menuLinks.map(link => (
                    <li key={link.name} className={classes.listItem} >
                      <Link className={classes.link} to={link.link}> {link.name} </Link>
                    </li>
                  ))}
                </ul>
              </div>
